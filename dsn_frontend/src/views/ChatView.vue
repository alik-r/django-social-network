            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <span class="text-xs text-gray-500">{{ chat.updated_at_formatted }} ago</span>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        setActiveChat(id) {
            console.log('setActiveChat id:', id)
            this.activeChat = id
            this.getMessages()
        },
        getChats() {
        ...
        submitForm() {
            console.log('submitForm (send message) body:', this.body)
            axios
                .post(`/api/chat/${this.activeChat.id}/send/`, {
                    body: this.body
                })
                .then(response => {
                    console.log('submitForm (send message) response:', response.data)
