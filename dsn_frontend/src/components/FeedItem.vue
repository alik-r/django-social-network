    ...
    <div class="my-6 flex justify-between">
        <div class="flex space-x-6 items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <RouterLink :to="{name: 'post_view', params: {id: post.id}}" class="text-gray-500 text-xs">{{ post.comments_count }} comments</RouterLink>
            </div>
    ...
    methods: {
        ...
        reportPost() {
            axios
                ...
                .then(response => {
                    console.log('reportPost response:', response.data)
                    if (response.data.message === 'reported') {
                        this.toastStore.showToast(5000, 'The post was reported', 'bg-emerald-500 text-white')
                    } else {
                        this.toastStore.showToast(5000, 'You have already reported this post', 'bg-orange-500 text-white')
                    }
                })
                .catch(error => {
                    console.log("error:", error);
        ...
        deletePost() {
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.toastStore.showToast(5000, 'The post was deleted', 'bg-emerald-500 text-white')
                })
                .catch(error => {
                    console.log("error:", error);
                })
